    ...
    return (
      ...
      <div className="col-lg-offset-1 col-md-6 col-lg-5 d-flex g-bg-primary g-pa-40"
        ...
        <div className="align-self-center w-100">
          <h2 className="text-left g-color-black text-uppercase g-font-weight-700 g-mb-50"> Have a
            <span className="g-color-white"> LOBU Account?</span>
          </h2>
          ...
          <form>
            <div className="form-group g-mb-10">
              <div className="row">
                ...
                <div className="col-sm-6"><input className="col-sm-6 form-control g-color-white g-bg-black-opacity-0_4 g-brd-black-opacity-0_4 g-brd-primary--focus rounded-0 g-pa-15" type="email" placeholder="Last Name"/></div>
              </div>
            </div>
            <div className="form-group g-mb-10">
      ...
      <div className="col-md-6 col-lg-5 d-flex g-bg-black-opacity-0_9 g-pa-40"
          style={{minHeight: '32em'}}>
        <div className="text-left">
          ...
          <div className="lead g-font-weight-400 g-mb-40">
            <p>Sign up with lobu to have an online presence as a potential customer in your community. Your account allows you to manage subscriptions to your favorite businesses to receive notifications about events, new products and special offers.</p>
          </div>
