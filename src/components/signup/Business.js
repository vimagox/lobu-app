...
export default class BusinessSignup extends React.Component {
  render() {
    return (
      ...
      <div className="col-lg-offset-1 col-md-6 col-lg-5 d-flex g-bg-black-opacity-0_9 g-pa-40"
        ...
        <div className="align-self-center w-100">
          ...
          <form>
            ...
            <button className="btn btn-md g-rounded-2 g-mt-30 u-btn-primary g-font-size-22 text-uppercase rounded-0 g-py-11 g-px-30">Signup my business</button>
          </form>
      ...
      <div className="col-md-6 col-lg-5 d-flex g-bg-primary g-pa-40"
            style={{minHeight: '32em'}}>
